...
MY_CPP_LIST += $(wildcard $(LOCAL_PATH)/log/*.cpp)
MY_CPP_LIST += $(wildcard $(LOCAL_PATH)/utils/*.cpp)

MY_CPP_INCLUDES := $(LOCAL_PATH)
MY_CPP_INCLUDES += $(LOCAL_PATH)/utils
MY_CPP_INCLUDES += $(LOCAL_PATH)/log
MY_CPP_INCLUDES += $(LOCAL_PATH)/concurrentqueue

common_shared_libraries := 
common_static_libraries := 

LOCAL_MODULE := timer_test
